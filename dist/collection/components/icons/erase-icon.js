export const EraseIcon = props => (`<span class="${`elsa-rounded-lg elsa-inline-flex elsa-p-3 elsa-bg-light-blue-50 elsa-text-light-blue-700 elsa-ring-4 elsa-ring-white`}">
