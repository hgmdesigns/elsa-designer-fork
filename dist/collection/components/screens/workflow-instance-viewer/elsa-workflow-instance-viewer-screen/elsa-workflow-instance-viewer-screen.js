...
export class ElsaWorkflowInstanceViewerScreen {
        ...
        return [
          h("div", { class: "-elsa-m-3 elsa-p-3 elsa-flex elsa-items-start elsa-rounded-lg hover:elsa-bg-gray-50 elsa-transition elsa-ease-in-out elsa-duration-150" },
            ...
            h("div", { class: "elsa-ml-4" },
              ...
              h("p", { class: "elsa-mt-1 elsa-text-sm elsa-text-gray-500" },
                ...
                h("pre", { class: "elsa-overflow-x-scroll elsa-max-w-md", onClick: e => clip(e.currentTarget) }, JSON.stringify(workflowFault, null, 1))))),
          h("a", { href: "#", class: "-elsa-m-3 elsa-p-3 elsa-flex elsa-items-start elsa-rounded-lg hover:elsa-bg-gray-50 elsa-transition elsa-ease-in-out elsa-duration-150" },
            ...
            h("div", { class: "elsa-ml-4" },
              ...
              h("p", { class: "elsa-mt-1 elsa-text-sm elsa-text-gray-500" }, moment(this.workflowInstance.faultedAt).format('DD-MM-YYYY HH:mm:ss'))))
        ];
      };
      const renderPerformance = () => {
        if (!!activityStats.fault)
          return;
        return [h("a", { href: "#", class: "-elsa-m-3 elsa-p-3 elsa-flex elsa-items-start elsa-rounded-lg hover:elsa-bg-gray-50 elsa-transition elsa-ease-in-out elsa-duration-150" },
            h("svg", { class: "elsa-flex-shrink-0 elsa-h-6 elsa-w-6 elsa-text-indigo-500", width: "24", height: "24", viewBox: "0 0 24 24", "stroke-width": "2", stroke: "currentColor", fill: "none", "stroke-linecap": "round", "stroke-linejoin": "round" },
              h("path", { stroke: "none", d: "M0 0h24v24H0z" }),
            ...
            h("div", { class: "elsa-ml-4" },
              ...
              h("p", { class: "elsa-mt-1 elsa-text-sm elsa-text-gray-500" }, durationToString(moment.duration(activityStats.averageExecutionTime))))),
          h("a", { href: "#", class: "-m-3 elsa-p-3 elsa-flex elsa-items-start elsa-rounded-lg hover:elsa-bg-gray-50 elsa-transition elsa-ease-in-out elsa-duration-150" },
            ...
            h("div", { class: "elsa-ml-4" },
              ...
              h("p", { class: "elsa-mt-1 elsa-text-sm elsa-text-gray-500" }, durationToString(moment.duration(activityStats.fastestExecutionTime))))),
          h("a", { href: "#", class: "-elsa-m-3 elsa-p-3 elsa-flex elsa-items-start elsa-rounded-lg hover:elsa-bg-gray-50 elsa-transition elsa-ease-in-out elsa-duration-150" },
            ...
            h("div", { class: "elsa-ml-4" },
              ...
              h("p", { class: "elsa-mt-1 elsa-text-sm elsa-text-gray-500" }, durationToString(moment.duration(activityStats.slowestExecutionTime))))),
          h("a", { href: "#", class: "-elsa-m-3 elsa-p-3 elsa-flex elsa-items-start elsa-rounded-lg hover:elsa-bg-gray-50 elsa-transition elsa-ease-in-out elsa-duration-150" },
            h("svg", { class: "elsa-flex-shrink-0 elsa-h-6 elsa-w-6 elsa-text-blue-600", width: "24", height: "24", viewBox: "0 0 24 24", "stroke-width": "2", stroke: "currentColor", fill: "none", "stroke-linecap": "round", "stroke-linejoin": "round" },
              h("path", { stroke: "none", d: "M0 0h24v24H0z" }),
              h("rect", { x: "4", y: "5", width: "16", height: "16", rx: "2" }),
            ...
            h("div", { class: "elsa-ml-4" },
              ...
              h("p", { class: "elsa-mt-1 elsa-text-sm elsa-text-gray-500" }, moment(activityStats.lastExecutedAt).format('DD-MM-YYYY HH:mm:ss'))))];
      };
  ...
  render() {
    ...
    return (h(Host, { class: "elsa-flex elsa-flex-col elsa-w-full elsa-relative", ref: el => this.el = el },
      this.renderCanvas(),
      h("elsa-workflow-instance-journal", { ref: el => this.journal = el, workflowInstanceId: this.workflowInstanceId, serverUrl: this.serverUrl, activityDescriptors: descriptors, workflowBlueprint: this.workflowBlueprint, workflowModel: this.workflowModel, onRecordSelected: e => this.onRecordSelected(e) })));
  }
  renderCanvas() {
    return (h("div", { class: "elsa-flex-1 elsa-flex" },
      h("elsa-designer-tree", { model: this.workflowModel, class: "elsa-flex-1", ref: el => this.designer = el, mode: WorkflowDesignerMode.Instance, activityContextMenuButton: this.renderActivityStatsButton, activityBorderColor: this.getActivityBorderColor, activityContextMenu: this.activityContextMenuState, selectedActivityIds: [this.selectedActivityId], onActivitySelected: e => this.onActivitySelected(e), onActivityDeselected: e => this.onActivityDeselected(e), onActivityContextMenuButtonClicked: e => this.onActivityContextMenuButtonClicked(e) }),
      this.renderActivityPerformanceMenu()));
  }
