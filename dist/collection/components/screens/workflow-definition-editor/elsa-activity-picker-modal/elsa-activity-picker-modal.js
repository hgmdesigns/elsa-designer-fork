...
import { ActivityTraits, EventTypes } from "../../../../models";
...
export class ElsaActivityPickerModal {
  ...
  render() {
    ...
    return (h(Host, { class: "elsa-block" },
      h("elsa-modal-dialog", { ref: el => this.dialog = el },
        h("div", { slot: "content", class: "elsa-py-8" },
          h("div", { class: "elsa-flex" },
            h("div", { class: "elsa-px-8" },
              h("nav", { class: "elsa-space-y-1", "aria-label": "Sidebar" }, categories.map(category => (h("a", { href: "#", onClick: e => this.onCategoryClick(e, category), class: `${category == this.selectedCategory ? selectedCategoryClass : defaultCategoryClass} elsa-text-gray-600 hover:elsa-bg-gray-50 hover:elsa-text-gray-900 elsa-flex elsa-items-center elsa-px-3 elsa-py-2 elsa-text-sm elsa-font-medium elsa-rounded-md` },
                h("span", { class: "elsa-truncate" }, category)))))),
            h("div", { class: "elsa-flex-1 elsa-pr-8" },
              h("div", { class: "elsa-p-0 elsa-mb-6" },
                h("div", { class: "elsa-relative elsa-rounded-md elsa-shadow-sm" },
                  h("div", { class: "elsa-absolute elsa-inset-y-0 elsa-left-0 elsa-pl-3 elsa-flex elsa-items-center elsa-pointer-events-none" },
                    h("svg", { class: "elsa-h-6 elsa-w-6 elsa-text-gray-400", width: "24", height: "24", viewBox: "0 0 24 24", "stroke-width": "2", stroke: "currentColor", fill: "none", "stroke-linecap": "round", "stroke-linejoin": "round" },
                      h("path", { stroke: "none", d: "M0 0h24v24H0z" }),
                      h("circle", { cx: "10", cy: "10", r: "7" }),
                      h("line", { x1: "21", y1: "21", x2: "15", y2: "15" }))),
                  h("input", { type: "text", value: this.searchText, onInput: e => this.onSearchTextChange(e), class: "form-input elsa-block elsa-w-full elsa-pl-10 sm:elsa-text-sm sm:elsa-leading-5 focus:elsa-ring-blue-500 focus:elsa-border-blue-500 elsa-rounded-md elsa-border-gray-300", placeholder: "Search activities" }))),
              h("div", { class: "elsa-max-w-4xl elsa-mx-auto elsa-p-0" }, categories.map(category => {
                ...
                if (displayContexts.length == 0)
                  return undefined;
                return (h("div", null,
                  h("h2", { class: "elsa-my-4 elsa-text-lg elsa-leading-6 elsa-font-medium" }, category),
                  h("div", { class: "elsa-divide-y elsa-divide-gray-200 sm:elsa-divide-y-0 sm:elsa-grid sm:elsa-grid-cols-2 sm:elsa-gap-px" }, displayContexts.map(displayContext => (h("a", { href: "#", onClick: e => this.onActivityClick(e, displayContext.activityDescriptor), class: "elsa-relative elsa-rounded elsa-group elsa-p-6 focus-within:elsa-ring-2 focus-within:elsa-ring-inset focus-within:elsa-ring-blue-500" },
                    h("div", { class: "elsa-flex elsa-space-x-10" },
                      h("div", { class: "elsa-flex elsa-flex-0 elsa-items-center" },
                        h("div", { innerHTML: displayContext.activityIcon })),
                      h("div", { class: "elsa-flex-1 elsa-mt-2" },
                        h("h3", { class: "elsa-text-lg elsa-font-medium" },
                          h("a", { href: "#", class: "focus:elsa-outline-none" },
                            h("span", { class: "elsa-absolute elsa-inset-0", "aria-hidden": "true" }),
                            displayContext.activityDescriptor.displayName)),
                        h("p", { class: "elsa-mt-2 elsa-text-sm elsa-text-gray-500" }, displayContext.activityDescriptor.description)))))))));
              }))))),
        h("div", { slot: "buttons" },
  ...
  static get is() { return "elsa-activity-picker-modal"; }
