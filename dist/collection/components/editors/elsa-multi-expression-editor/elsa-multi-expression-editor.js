...
export class ElsaMultiExpressionEditor {
  ...
  renderContextMenuWidget() {
    ...
    return h("div", { class: "elsa-relative", ref: el => registerClickOutside(this, el, this.closeContextMenu) },
      h("button", { type: "button", class: `elsa-border-0 focus:elsa-outline-none elsa-text-sm ${advancedButtonClass}`, onClick: e => this.onSettingsClick(e) }, !this.isDisabled ? this.renderContextMenuButton() : ""),
      h("div", null,
