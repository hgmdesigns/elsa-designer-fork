...
function setupMode(defaults) {
    ...
    registerProviders();
    disposables.push(contextConsumer_elsaActivityEditorModal_elsaActivityPickerModal_elsaDesignerTree_elsaModalDialog_elsaMonaco_elsaToastNotification_elsaWorkflowDefinitionEditorNotifications_elsaWorkflowDefinitionEditorScreen_elsaWorkflowPublishButton_elsaWorkflowSettingsModal_entry.languages.setLanguageConfiguration(defaults.languageId, richEditConfiguration));
