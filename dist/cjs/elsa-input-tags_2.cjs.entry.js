...
const elsaInputTagsCss = ".elsa-tag-input:focus{outline:none!important;box-shadow:none!important}";
...
const ElsaInputTags = class {
  ...
  render() {
    ...
    return (index.h("div", { class: "elsa-py-2 elsa-px-3 elsa-bg-white elsa-shadow-sm elsa-border elsa-border-gray-300 elsa-rounded-md" }, values.map(value => (index.h("a", { href: "#", onClick: e => this.onDeleteTagClick(e, value), class: "elsa-inline-block elsa-text-xs elsa-bg-blue-400 elsa-text-white elsa-py-2 elsa-px-3 elsa-mr-1 elsa-mb-1 elsa-rounded" }, index.h("span", null, value), index.h("span", { class: "elsa-text-white hover:elsa-text-white elsa-ml-1" }, "\u00D7")))), index.h("input", { type: "text", id: this.fieldId, onKeyDown: e => this.onInputKeyDown(e), onBlur: e => this.onInputBlur(e), class: "elsa-tag-input elsa-inline-block elsa-text-sm elsa-outline-none focus:elsa-outline-none elsa-border-none shadow:none focus:elsa-border-none focus:elsa-border-transparent focus:shadow-none", placeholder: this.placeHolder }), index.h("input", { type: "hidden", name: this.fieldName, value: valuesJson })));
  }
...
exports.elsa_input_tags = ElsaInputTags;
exports.elsa_input_tags_dropdown = ElsaInputTagsDropdown;
