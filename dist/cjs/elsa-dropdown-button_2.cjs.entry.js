...
const ElsaPager = class {
  ...
  render() {
    ...
    const self = this;
    const currentQuery = utils.parseQuery(this.history.location.search);
    ...
    return (index.h("div", { class: "elsa-bg-white elsa-px-4 elsa-py-3 elsa-flex elsa-items-center elsa-justify-between elsa-border-t elsa-border-gray-200 sm:elsa-px-6" }, index.h("div", { class: "elsa-flex-1 elsa-flex elsa-justify-between sm:elsa-hidden" }, renderPreviousButton(), renderNextButton()), index.h("div", { class: "hidden sm:elsa-flex-1 sm:elsa-flex sm:elsa-items-center sm:elsa-justify-between" }, index.h("div", null, index.h("p", { class: "elsa-text-sm elsa-leading-5 elsa-text-gray-700 elsa-space-x-0-5" }, index.h("span", null, "Showing"), index.h("span", { class: "elsa-font-medium" }, from), index.h("span", null, "to"), index.h("span", { class: "elsa-font-medium" }, to), index.h("span", null, "of"), index.h("span", { class: "elsa-font-medium" }, totalCount), index.h("span", null, "results"))), index.h("div", null, index.h("nav", { class: "elsa-relative elsa-z-0 elsa-inline-flex elsa-shadow-sm" }, renderChevronLeft(), renderPagerButtons(), renderChevronRight())))));
  }
};
