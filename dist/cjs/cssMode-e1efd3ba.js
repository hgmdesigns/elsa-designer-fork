...
var DiagnosticsAdapter = /** @class */ (function () {
    function DiagnosticsAdapter(_languageId, _worker, defaults) {
        ...
        this._disposables.push(contextConsumer_elsaActivityEditorModal_elsaActivityPickerModal_elsaDesignerTree_elsaModalDialog_elsaMonaco_elsaToastNotification_elsaWorkflowDefinitionEditorNotifications_elsaWorkflowDefinitionEditorScreen_elsaWorkflowPublishButton_elsaWorkflowSettingsModal_entry.editor.onDidCreateModel(onModelAdd));
    ...
    DiagnosticsAdapter.prototype._doValidate = function (resource, languageId) {
        this._worker(resource)
            ...
            var model = contextConsumer_elsaActivityEditorModal_elsaActivityPickerModal_elsaDesignerTree_elsaModalDialog_elsaMonaco_elsaToastNotification_elsaWorkflowDefinitionEditorNotifications_elsaWorkflowDefinitionEditorScreen_elsaWorkflowPublishButton_elsaWorkflowSettingsModal_entry.editor.getModel(resource);
...
function toRange(range) {
    ...
    return new contextConsumer_elsaActivityEditorModal_elsaActivityPickerModal_elsaDesignerTree_elsaModalDialog_elsaMonaco_elsaToastNotification_elsaWorkflowDefinitionEditorNotifications_elsaWorkflowDefinitionEditorScreen_elsaWorkflowPublishButton_elsaWorkflowSettingsModal_entry.Range(range.start.line + 1, range.start.character + 1, range.end.line + 1, range.end.character + 1);
}
...
function toCompletionItemKind(kind) {
    var mItemKind = contextConsumer_elsaActivityEditorModal_elsaActivityPickerModal_elsaDesignerTree_elsaModalDialog_elsaMonaco_elsaToastNotification_elsaWorkflowDefinitionEditorNotifications_elsaWorkflowDefinitionEditorScreen_elsaWorkflowPublishButton_elsaWorkflowSettingsModal_entry.languages.CompletionItemKind;
    switch (kind) {
...
var CompletionAdapter = /** @class */ (function () {
    ...
    CompletionAdapter.prototype.provideCompletionItems = function (model, position, context, token) {
        ...
        return this._worker(resource)
            ...
            var wordRange = new contextConsumer_elsaActivityEditorModal_elsaActivityPickerModal_elsaDesignerTree_elsaModalDialog_elsaMonaco_elsaToastNotification_elsaWorkflowDefinitionEditorNotifications_elsaWorkflowDefinitionEditorScreen_elsaWorkflowPublishButton_elsaWorkflowSettingsModal_entry.Range(position.lineNumber, wordInfo.startColumn, position.lineNumber, wordInfo.endColumn);
            var items = info.items.map(function (entry) {
                ...
                if (entry.insertTextFormat === InsertTextFormat.Snippet) {
                    item.insertTextRules = contextConsumer_elsaActivityEditorModal_elsaActivityPickerModal_elsaDesignerTree_elsaModalDialog_elsaMonaco_elsaToastNotification_elsaWorkflowDefinitionEditorNotifications_elsaWorkflowDefinitionEditorScreen_elsaWorkflowPublishButton_elsaWorkflowSettingsModal_entry.languages.CompletionItemInsertTextRule.InsertAsSnippet;
                }
                return item;
            });
            return {
...
function toLocation(location) {
    return {
        uri: contextConsumer_elsaActivityEditorModal_elsaActivityPickerModal_elsaDesignerTree_elsaModalDialog_elsaMonaco_elsaToastNotification_elsaWorkflowDefinitionEditorNotifications_elsaWorkflowDefinitionEditorScreen_elsaWorkflowPublishButton_elsaWorkflowSettingsModal_entry.Uri.parse(location.uri),
...
function toWorkspaceEdit(edit) {
    ...
    for (var uri in edit.changes) {
        var _uri = contextConsumer_elsaActivityEditorModal_elsaActivityPickerModal_elsaDesignerTree_elsaModalDialog_elsaMonaco_elsaToastNotification_elsaWorkflowDefinitionEditorNotifications_elsaWorkflowDefinitionEditorScreen_elsaWorkflowPublishButton_elsaWorkflowSettingsModal_entry.Uri.parse(uri);
...
function toSymbolKind(kind) {
    var mKind = contextConsumer_elsaActivityEditorModal_elsaActivityPickerModal_elsaDesignerTree_elsaModalDialog_elsaMonaco_elsaToastNotification_elsaWorkflowDefinitionEditorNotifications_elsaWorkflowDefinitionEditorScreen_elsaWorkflowPublishButton_elsaWorkflowSettingsModal_entry.languages.SymbolKind;
    switch (kind) {
...
function toFoldingRangeKind(kind) {
    switch (kind) {
        case FoldingRangeKind.Comment:
            return contextConsumer_elsaActivityEditorModal_elsaActivityPickerModal_elsaDesignerTree_elsaModalDialog_elsaMonaco_elsaToastNotification_elsaWorkflowDefinitionEditorNotifications_elsaWorkflowDefinitionEditorScreen_elsaWorkflowPublishButton_elsaWorkflowSettingsModal_entry.languages.FoldingRangeKind.Comment;
        case FoldingRangeKind.Imports:
            return contextConsumer_elsaActivityEditorModal_elsaActivityPickerModal_elsaDesignerTree_elsaModalDialog_elsaMonaco_elsaToastNotification_elsaWorkflowDefinitionEditorNotifications_elsaWorkflowDefinitionEditorScreen_elsaWorkflowPublishButton_elsaWorkflowSettingsModal_entry.languages.FoldingRangeKind.Imports;
...
function setupMode(defaults) {
    ...
    function registerProviders() {
        ...
        if (modeConfiguration.completionItems) {
            providers.push(contextConsumer_elsaActivityEditorModal_elsaActivityPickerModal_elsaDesignerTree_elsaModalDialog_elsaMonaco_elsaToastNotification_elsaWorkflowDefinitionEditorNotifications_elsaWorkflowDefinitionEditorScreen_elsaWorkflowPublishButton_elsaWorkflowSettingsModal_entry.languages.registerCompletionItemProvider(languageId, new CompletionAdapter(worker)));
        }
        if (modeConfiguration.hovers) {
            providers.push(contextConsumer_elsaActivityEditorModal_elsaActivityPickerModal_elsaDesignerTree_elsaModalDialog_elsaMonaco_elsaToastNotification_elsaWorkflowDefinitionEditorNotifications_elsaWorkflowDefinitionEditorScreen_elsaWorkflowPublishButton_elsaWorkflowSettingsModal_entry.languages.registerHoverProvider(languageId, new HoverAdapter(worker)));
        }
        if (modeConfiguration.documentHighlights) {
            providers.push(contextConsumer_elsaActivityEditorModal_elsaActivityPickerModal_elsaDesignerTree_elsaModalDialog_elsaMonaco_elsaToastNotification_elsaWorkflowDefinitionEditorNotifications_elsaWorkflowDefinitionEditorScreen_elsaWorkflowPublishButton_elsaWorkflowSettingsModal_entry.languages.registerDocumentHighlightProvider(languageId, new DocumentHighlightAdapter(worker)));
        }
        ...
        if (modeConfiguration.documentSymbols) {
            providers.push(contextConsumer_elsaActivityEditorModal_elsaActivityPickerModal_elsaDesignerTree_elsaModalDialog_elsaMonaco_elsaToastNotification_elsaWorkflowDefinitionEditorNotifications_elsaWorkflowDefinitionEditorScreen_elsaWorkflowPublishButton_elsaWorkflowSettingsModal_entry.languages.registerDocumentSymbolProvider(languageId, new DocumentSymbolAdapter(worker)));
        }
        if (modeConfiguration.rename) {
            providers.push(contextConsumer_elsaActivityEditorModal_elsaActivityPickerModal_elsaDesignerTree_elsaModalDialog_elsaMonaco_elsaToastNotification_elsaWorkflowDefinitionEditorNotifications_elsaWorkflowDefinitionEditorScreen_elsaWorkflowPublishButton_elsaWorkflowSettingsModal_entry.languages.registerRenameProvider(languageId, new RenameAdapter(worker)));
        }
        if (modeConfiguration.colors) {
            providers.push(contextConsumer_elsaActivityEditorModal_elsaActivityPickerModal_elsaDesignerTree_elsaModalDialog_elsaMonaco_elsaToastNotification_elsaWorkflowDefinitionEditorNotifications_elsaWorkflowDefinitionEditorScreen_elsaWorkflowPublishButton_elsaWorkflowSettingsModal_entry.languages.registerColorProvider(languageId, new DocumentColorAdapter(worker)));
        }
        ...
        if (modeConfiguration.selectionRanges) {
            providers.push(contextConsumer_elsaActivityEditorModal_elsaActivityPickerModal_elsaDesignerTree_elsaModalDialog_elsaMonaco_elsaToastNotification_elsaWorkflowDefinitionEditorNotifications_elsaWorkflowDefinitionEditorScreen_elsaWorkflowPublishButton_elsaWorkflowSettingsModal_entry.languages.registerSelectionRangeProvider(languageId, new SelectionRangeAdapter(worker)));
        }
    }
    registerProviders();
